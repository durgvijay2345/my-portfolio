      ...
      <div className="space-y-12">
        ...
        <div className="text-center">
          ...
          <p className="text-base md:text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed">
            ...
            , a passionate{" "}import React from "react";
      ...
      <div className="space-y-12">
        ...
        <div className="text-center">
          ...
          <p className="text-base md:text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed">
            ...
            I build scalable web applications, AI-driven systems, and
            performance-oriented software solutions using modern technologies.
            With strong foundations in Data Structures, Algorithms, and Core
            Computer Science, I aim to solve real-world problems through
            innovation, clean architecture, and intelligent system design.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-6 md:pl-8 text-gray-700 space-y-2">
            ...
            <li>
              Achieved{" "}
              <span className="font-medium">
                Codeforces Rating 1640 (Expert)
              </span>{" "}
              and 3-Star rating on CodeChef
            </li>
            <li>
              1700+ LeetCode rating with consistent performance in coding
              contests
            </li>
            <li>
              Built AI-based systems and full-stack scalable applications
              solving real-world problems
            </li>
            <li>
              Continuous learner in AI, System Design, and Advanced Software
              Development
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-base md:text-lg text-gray-700 leading-relaxed">
            ...
            Engineer by leveraging expertise in Full-Stack Development,
            Artificial Intelligence, and scalable system design to build
            intelligent, efficient, and impactful digital solutions. I strive
            to solve real-world challenges through AI-driven innovation,
            continuous learning, and high-quality software engineering.
          </p>
        </div>
      </div>
    </div>
